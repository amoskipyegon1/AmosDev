<template>
    <nav
        class="z-50 grid grid-cols-2 sm:grid-cols-3 gap-x-2 w-full px-4 md:px-8 lg:px-20 py-3 md:py-2.5 lg:py-4 sticky top-0 bg-tate border-b border-neutral-800"
    >
