...
<template>
    <section class="w-full flex flex-col gap-y-0 md:gap-y-4">
        ...
        <div
            ref="mobilenav"
            class="w-full sm:hidden flex flex-row flex-wrap gap-x-2 fixed bottom-0 py-3 px-10 bg-tate z-50 border-neutral-800 border-t shadow-lg transition duration-[2s]"
